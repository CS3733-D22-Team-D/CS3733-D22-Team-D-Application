...
public class DefaultController extends ParentController {
  ...
  private void initConnectionImage() {
    //    if
    // (!SecurityController.getUser().getEmployeeType().equals(Employee.EmployeeType.ADMINISTRATOR))
    //      return;
  ...
  private void updateDate() {
    ...
    //          @Override
    //          public void run() {
    //            // use Platform.runLater(Runnable runnable) If you need to update a GUI component
    // from a
    //            // non-GUI thread.
    //            Platform.runLater(
    //                () -> {
