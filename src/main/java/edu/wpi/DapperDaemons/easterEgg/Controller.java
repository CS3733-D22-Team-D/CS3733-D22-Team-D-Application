/**
 * @author Jessie Baskauf and Ellie Mamantov The Controller handles user input and coordinates the
 *     updating of the model and the view with the help of a timer.
 */
...
public class Controller implements EventHandler<KeyEvent> {
  ...
  private static final String[] levelFiles = {
    "src/levels/level1.txt", "src/levels/level2.txt", "src/levels/level3.txt"
  };
  ...
  /**
   * Steps the PacManModel, updates the view, updates score and level, displays Game Over/You Won,
   * and instructions of how to play
   *
  ...
  private void update(PacManModel.Direction direction) {
    ...
    // when PacMan is in ghostEatingMode, count down the ghostEatingModeCounter to reset
    // ghostEatingMode to false when the counter is 0
