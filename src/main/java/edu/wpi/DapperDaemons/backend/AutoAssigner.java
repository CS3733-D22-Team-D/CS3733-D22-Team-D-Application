...
public class AutoAssigner {
    ...
    public static String assignAdmin() {
        List<Employee> employeeList = new ArrayList<>(DAOPouch.getEmployeeDAO().filter(5,"ADMINISTRATOR").values());
    ...
    public static String assignDoctor() {
        List<Employee> employeeList = new ArrayList<>(DAOPouch.getEmployeeDAO().filter(5,"DOCTOR").values());
    ...
    public static String assignNurse() {
        List<Employee> employeeList = new ArrayList<>(DAOPouch.getEmployeeDAO().filter(5,"NURSE").values());
    ...
    public static String assignJanitor() {
        List<Employee> employeeList = new ArrayList<>(DAOPouch.getEmployeeDAO().filter(5,"JANITOR").values());
