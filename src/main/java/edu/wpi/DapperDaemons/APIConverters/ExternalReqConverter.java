...
public class ExternalReqConverter {
     ...
     */
    public static PatientTransportRequest convert(ExternalTransportRequest extRequest, String origin, String destination) {
        return new PatientTransportRequest(Request.Priority.LOW, origin, extRequest.getIssuerID(),
                extRequest.getHandlerID(), "Called using Team-Z API. Using transport method: " +
                extRequest.getTransportMethod().toString(), extRequest.getPatientID(), destination, "ASAP");
    }
