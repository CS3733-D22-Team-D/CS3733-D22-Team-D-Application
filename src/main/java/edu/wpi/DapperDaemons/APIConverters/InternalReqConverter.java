...
public class InternalReqConverter extends Converter {
     ...
     */
    public static edu.wpi.DapperDaemons.entities.requests.Request.Priority parsePriority(int priority) {
        if(priority == 1 || priority == 2) return edu.wpi.DapperDaemons.entities.requests.Request.Priority.LOW;
        else if(priority == 3) return edu.wpi.DapperDaemons.entities.requests.Request.Priority.MEDIUM;
        else if(priority == 4 || priority == 5) return edu.wpi.DapperDaemons.entities.requests.Request.Priority.HIGH;
